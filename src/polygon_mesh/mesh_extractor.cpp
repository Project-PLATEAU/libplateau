...
namespace plateau::polygonMesh {
    namespace {
        ...
        void extractInner(Model& out_model, const citygml::CityModel& city_model,
            ...
            const auto geo_reference = geometry::GeoReference(options.coordinate_zone_id, (geometry::Vector3d)options.reference_point, options.unit_scale, options.mesh_axes);
